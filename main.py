...
class Window:
    ...
    def consult(self):
        ...
        MessageBox.showinfo("Ruta mas corta!",
                            f'Ruta: {result[0]}  Costo: {result[1]} ')
